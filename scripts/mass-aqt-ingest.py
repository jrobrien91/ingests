...
if __name__ == '__main__':
    ...
    descript = ("Mass Ingest for CROCUS AQT Data (b-level dataset)")
    parser = argparse.ArgumentParser(description=descript,
                                             usage=(
            "python mass-ingest-aqt.py --outdir /user/dev/crocus/"
        )
    )
    ...
    parser.add_argument("--start_date",
                        dest='start_date',
                        default=None,
                        help="[Default|None] Date to pass to ingest-aqt.py in YYYY-MM-DD format"
    )
    ...
    parser.add_argument('--outdir',
                        ...
                        dest="outdir",
                        default="./",
                        help='[Default|Current Directory] Output directory to pass to ingest-aqt.py b-level files.')
